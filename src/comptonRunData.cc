...
void comptonRunData::AddGDMLFile( const char *fn )
{
    ...
    fGDMLFiles.push_back(comptonTextFile(fn));
}

void comptonRunData::RecreateGDML( const char *adir, bool clobber )
{
