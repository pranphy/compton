...
std::map<G4int,G4String> comptonGenC12::fNamesMap = comptonGenC12::CreateNamesMap();

std::map<G4int,G4String> comptonGenC12::CreateNamesMap() {
...
comptonGenC12::comptonGenC12(G4int physicsType)
: comptonVEventGen(fNamesMap[physicsType]) {
    type = physicsType;
...
comptonGenC12::~comptonGenC12() {
}

void comptonGenC12::SamplePhysics(comptonVertex *vert, comptonEvent *evt) {
...
void comptonGenC12::GenInelastic(G4double beamE,G4double theta,
...
void comptonGenC12::GenQuasiElastic(G4double beamE,G4double theta,
				  G4double &Q2,G4double &W2,G4double &effectiveXsection,
				  G4double &fWeight,G4double &eOut,G4double &asym) {  
  G4double F1 = 0.0;
  G4double F2 = 0.0;
...
void comptonGenC12::GenElastic(G4double beamE,G4double theta,
			     G4double &Q2,G4double &W2,G4double &effectiveXsection,
			     G4double &fWeight,G4double &eOut,G4double &asym) {
  // Physical Constants      
