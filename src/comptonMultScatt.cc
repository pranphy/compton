...
comptonMultScatt::comptonMultScatt() {
    InitInternal();
}

comptonMultScatt::comptonMultScatt(double p, const std::vector<std::tuple<double,double,double>>& m)
: comptonMultScatt() {
    /*
       p    - electron momentum
      (t,   - Thickness
...
comptonMultScatt::comptonMultScatt(double p, const std::tuple<double,double,double>& m) {
    /*
       p    - electron momentum
      (t,   - Thickness
       A,   - Mass number
...
void comptonMultScatt::InitInternal(){
    fInit = false;
    fErf2sig = erf(2.0/sqrt(2.0));
}

void comptonMultScatt::Init(double p, const std::vector<std::tuple<double,double,double>>& m) {
    /*
...
void   comptonMultScatt::Init(double p, const std::tuple<double,double,double>& m) {
    /*
...
double comptonMultScatt::J0(double x) {
...
double comptonMultScatt::solvelogeq(double b){
...
double comptonMultScatt::fn_integrand( double u, double th, int n ){
...
double comptonMultScatt::intsimpson_fn( double th, int n ){
...
double comptonMultScatt::CalcMSDistPlane( double theta, double p, const std::tuple<double,double,double>& m) {
    Init(p, m);
    return CalcMSDistPlane(theta);
}

double comptonMultScatt::CalcMSDistPlane( double theta, double p, const std::vector<std::tuple<double,double,double>>& m) {
    Init(p, m);
    return CalcMSDistPlane(theta);
}

double comptonMultScatt::CalcMSDistPlane( double theta) {
    /*
       p    - electron momentum
       t    - Thickness
       A    - Mass number
...
double comptonMultScatt::CalcMSDist( double theta, double p, const std::tuple<double,double,double>& m) {
    Init(p, m);
    return CalcMSDist(theta);
}

double comptonMultScatt::CalcMSDist( double theta, double p, const std::vector<std::tuple<double,double,double>>& m) {
    Init(p, m);
    assert( !std::isnan(theta));
    return CalcMSDist(theta);
}

double comptonMultScatt::CalcMSDist( double theta){
    assert( !std::isnan(theta));
    return CalcMSDistPlane(theta)*sin(fabs(theta));
}

double comptonMultScatt::GenerateMSPlane(){
    /*
...
double comptonMultScatt::GenerateMSPlane(double p, const std::vector<std::tuple<double,double,double>>& m) {
    /*
       p    - electron momentum, [GeV]
       t    - Thickness [g/cm2]
       A    - Mass number
...
double comptonMultScatt::GenerateMSPlane(double p, const std::tuple<double,double,double>& m) {
    /*
       p    - electron momentum
       t    - Thickness
       A    - Mass number
...
double comptonMultScatt::GenerateMS(){
...
double comptonMultScatt::GenerateMS(double p, const std::vector<std::tuple<double,double,double>>& m) {
    /*
       p    - electron momentum
       t    - Thickness
       A    - Mass number
...
double comptonMultScatt::GenerateMS(double p, const std::tuple<double,double,double>& m) {
    /*
       p    - electron momentum
       t    - Thickness
       A    - Mass number
