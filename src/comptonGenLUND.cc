...
comptonGenLUND::comptonGenLUND()
: comptonVEventGen("pion_LUND") {
  // Initialize fRunData
  fRunData = comptonRun::GetRunData();
  ...
  fThisGenMessenger.DeclareMethod("LUND_filename",&comptonGenLUND::SetLUNDFile,"LUND Input filename");
}
...
void comptonGenLUND::SamplePhysics(comptonVertex * /*vert*/, comptonEvent *evt)
{
...
void comptonGenLUND::SetLUNDFile(G4String& filename)
{
