...
comptonTrackReconstruct::comptonTrackReconstruct(){
  ClearTrack();
}

comptonTrackReconstruct::~comptonTrackReconstruct(){;}

void comptonTrackReconstruct::AddHit(comptonGenericDetectorHit* aHit){
...
void comptonTrackReconstruct::ClearTrack(){
...
void comptonTrackReconstruct::PrintHitInfo(std::vector<comptonGenericDetectorHit*> aHitVec){
...
G4int comptonTrackReconstruct::ReconstructTrack(){

  if(TrackingVerbose)
    G4cout << "\n***** Calling comptonTrackReconstruct::ReconstructTrack() *****\n" << G4endl;
  ...
  if(TrackingVerbose)
    G4cout << "\n***** Leaving comptonTrackReconstruct::ReconstructTrack() *****\n" << G4endl;
...
G4int comptonTrackReconstruct::EvaluateTrack(std::vector <G4ThreeVector> Pos,
...
G4ThreeVector comptonTrackReconstruct::EvaluateTrack(std::vector <G4double> rPosX,
						    std::vector <G4double> rPosZ,
						    std::vector <G4double> rGEMResX){
  if(EvalTrackVerbose){
    G4cout << "Entering comptonTrackReconstruct::EvaluateTrack(...)" << G4endl;
  ...
  if(EvalTrackVerbose)
    G4cout << "Leaving comptonTrackReconstruct::EvaluateTrack(...)" << G4endl;
...
void comptonTrackReconstruct::FillRecTrackHit()
{
  for (size_t i = 0; i < aTrackHit.size(); i++) {
...
// and average them
void comptonTrackReconstruct::EvalTheta()
{
  if(EvalTrackVerbose)
    G4cout << "Entering comptonTrackReconstruct::EvalTheta() ..." << G4endl;
  ...
  if(EvalTrackVerbose)
    G4cout << "Leaving comptonTrackReconstruct::EvalTheta() ..." << G4endl;
}

// return y = a + bx
G4double comptonTrackReconstruct::EvalTrackPos(G4double z, G4ThreeVector &ab)
{
...
G4double comptonTrackReconstruct::EvalTrackAng(G4double /* z */, G4ThreeVector &ab)
{
  return ab.y();  // in rad
}
