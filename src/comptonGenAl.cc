...
std::map<G4int,G4String> comptonGenAl::fNamesMap = comptonGenAl::CreateNamesMap();

std::map<G4int,G4String> comptonGenAl::CreateNamesMap() {
...
comptonGenAl::comptonGenAl(G4int physicsType)
...
comptonGenAl::~comptonGenAl() {
}

void comptonGenAl::SamplePhysics(comptonVertex *vert, comptonEvent *evt) {
...
void comptonGenAl::GenInelastic(G4double beamE,G4double theta,
...
void comptonGenAl::GenQuasiElastic(G4double beamE,G4double theta,
				  G4double &Q2,G4double &W2,G4double &effectiveXsection,
				  G4double &fWeight,G4double &eOut,G4double &asym) {  
  G4double F1 = 0.0;
  G4double F2 = 0.0;
...
void comptonGenAl::GenElastic(G4double beamE,G4double theta,
			     G4double &Q2,G4double &W2,G4double &effectiveXsection,
			     G4double &fWeight,G4double &eOut,G4double &asym) {
