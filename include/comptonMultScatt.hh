...
class comptonMultScatt {

    public:
	comptonMultScatt();
	comptonMultScatt(double p, const std::tuple<double,double,double>& m);
	comptonMultScatt(double p, const std::vector<std::tuple<double,double,double>>& m);
