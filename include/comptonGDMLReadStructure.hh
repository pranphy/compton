...
//#include "comptonGDMLReadParamvol.hh"
...
class comptonGDMLReadStructure : public G4GDMLReadStructure {
    public:
    comptonGDMLReadStructure():G4GDMLReadStructure(){
        std::cout<<"This constructor called to read the structure"<<std::endl;
    }
    ...
    {
        std::cout<<"PRAKASH: Solved now for real "<<std::endl;
        G4String name;
        G4String volname;
    ...
    {
        std::cout<<"PRAKASH:: Reading Physical Volume"<<std::endl;
        G4String name;
        ...
        for(xercesc::DOMNode* iter = physvolElement->getFirstChild(); iter != nullptr; iter = iter->getNextSibling())
        {
            ...
            {
                std::cout<<"Prakash REading file now here is the problem"<<std::endl;
    ...
    {
        std::cout<<"I am here reading content"<<std::endl;
