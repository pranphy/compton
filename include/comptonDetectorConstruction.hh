...
class comptonDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  private:
    ...
    comptonDetectorConstruction(const comptonDetectorConstruction&);
    comptonDetectorConstruction& operator=(comptonDetectorConstruction);
  ...
  public:
    ...
    static G4ThreadLocal comptonGlobalField* fGlobalField;
